...
public class PaytmInitiateTransactionService implements PaymentGatewayService<PaytmTransaction> {

	private static final Logger LOGGER = Logger.getLogger(PaytmInitiateTransactionService.class.getName());
	...
	public PaytmInitiateTransactionService(String userId, String orderId, long amount, String currency) {
